...
import { clearKeys, loadKey, storeKey } from "./keys";
...
export class CryptoService {
  ...
  public async init(): Promise<boolean> {
    this.publicKey = (await loadKey("public")) ?? null;
    this.privateKey = (await loadKey("private")) ?? null;
  ...
  public async pollForSeed() {
    ...
    console.log("publicKeyBase64: " + this.publicKeyBase64);
    return await this.syncSeed(this.publicKeyBase64!!);
  }
